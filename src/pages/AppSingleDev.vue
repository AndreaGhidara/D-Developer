    ...
    <div class="container-fluid my_img-up">
        <div class="container rounded px-5">
            <div class="row py-5">
                ...
                <!-- left side -->
                <div class="col-md-4 col-12 p-3 mb-2 rounded-5 align-self-start shadow bg-white">
                ...
                <!-- right side -->
                <div class="col-12 col-md-7 offset-md-1 p-3 rounded-5 shadow bg-white">
    ...
    <div class="container-fluid">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 d-flex flex-column">
                                <p class="mt-4">
                                    <button class="col btn btn-primary shadow button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                        <div class="wave"></div>
                                        <span class="text">RECENSIONE</span>
                                    </button>
                                </p>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 d-flex flex-column">
                                <p>
                                    <button class=" btn btn-primary shadow button" type="button" data-bs-toggle="collapse" data-bs-target="#messaggi" aria-expanded="false" aria-controls="messaggi">
...
input,textarea,select,option{
    border: none;
    border-bottom: 1px solid #F87865;
    border-radius: 0;
    outline: none;
