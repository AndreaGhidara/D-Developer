...
<template>
    ...
    <div v-if="store.showPopupMessages" class="alert alert-success alert-dismissible popup fade show">
        ...
        <button @click="store.closePopupMessages" type="button" class="btn-close" data-bs-dismiss="alert"
    ...
    <div v-if="store.showPopupReviews" class="alert alert-success alert-dismissible popup fade show">
        ...
        <button @click="store.closePopupReviews" type="button" class="btn-close" data-bs-dismiss="alert"
            aria-label="Close"></button>
    </div>
    ...
    <div v-if="store.showPopupValutations" class="alert alert-success alert-dismissible popup fade show">
        ...
        <button @click="store.closePopupValutations" type="button" class="btn-close" data-bs-dismiss="alert"
            aria-label="Close"></button>
    </div>
</template>
